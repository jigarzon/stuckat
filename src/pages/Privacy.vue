<template>
  <q-page padding>
    ...
    <p>El presente Política de Privacidad establece los términos en que
      ...
      ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo
    ...
    <p>Nuestro sitio web emplea la información con el fin de proporcionar el
      ...
      productos y otra información publicitaria que consideremos relevante para
    ...
    <p>Nuestro sitio web emplea las cookies para poder identificar
      las páginas que son visitadas y su frecuencia. Esta información es
      empleada únicamente para análisis estadístico y después la información se
      elimina de forma permanente. Usted puede eliminar las cookies en cualquier
      momento desde su ordenador. Sin embargo las cookies ayudan a proporcionar
      un mejor servicio de los sitios web, estás no dan acceso a información de
      ...
      sin embargo la mayoría de navegadores aceptan cookies automáticamente pues
      ...
      posible que no pueda utilizar algunos de nuestros servicios.</p>
    <p><strong>Enlaces a Terceros</strong></p>
    <p>Este sitio web pudiera contener en laces a otros sitios que pudieran ser
      ...
      y por lo tanto no somos responsables de los términos o privacidad ni de la
      protección de sus datos en esos otros sitios terceros. Dichos sitios están
      sujetos a sus propias políticas de privacidad por lo cual es recomendable
    ...
    <p>En cualquier momento usted puede restringir la recopilación o el uso de
