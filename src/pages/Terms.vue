<template>
  <q-page padding>
    ...
    <p>Es requisito necesario para el uso de este sitio, que lea y acepte los
      ...
      aceptado los Términos y Condiciones de Uso en el presente documento. Todas
    ...
    <p>El usuario puede elegir y cambiar la clave para su acceso de
      ...
      productos. varados.info no asume la responsabilidad en caso de que
      entregue dicha clave a terceros.</p>
    <p>Todas las transacciones que se lleven a cabo por medio de este
      sitio web, están sujetas a un proceso de confirmación y verificación, el
      cual podría incluir el cumplimiento de las condiciones requeridas. En
      algunos casos puede que se requiera una
    ...
    <p>Este sitio web varados.info garantiza que la información
    ...
    <p>La suscripción a boletines de correos electrónicos publicitarios es
      voluntaria y podría ser seleccionada al momento de crear su cuenta.</p>
    <p>Varados.info reserva los derechos de cambiar o de modificar estos
